...
func (w *Wallet) InitWallet() error {
	...
	nextSeed, err := w.FetchNextDBSeed()
	if err != nil {
		return err
	}
	if nextSeed == nil {
...
func (w *Wallet) GetAllAddresses() ([]*factom.FactoidAddress, []*factom.ECAddress, error) {
	fcs, err := w.FetchAllFCTAddresses()
	if err != nil {
		return nil, nil, err
	}
	ecs, err := w.FetchAllECAddresses()
	if err != nil {
		return nil, nil, err
	}
